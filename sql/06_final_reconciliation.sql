...
--
-- Rules:
-- 1. Campaigns must have cleared creation approval and processing.
-- 2. Retry chains count distinct customers across the entire chain once.
-- 3. Standalone campaigns count every send event, including repeated
--    sends to the same customer.
